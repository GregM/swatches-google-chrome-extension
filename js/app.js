  ...
  */
   ...
   */
   function nodeCount (colors) {
    ...
    var colors = colorCount === 1 ? ' color' : ' colors';
    document.getElementsByClassName('inspected-elements')[0].innerText = colorCount + colors;
   };
  ...
  */
  ...
  function displayColors () {
    ...
    _.map(swatches.countByColor, function (o, idx) {
        ...
        //     move: function (color) { },
        //     show: function () { $(this).parents('.edit-color-wrapper').show(); },
        //     beforeShow: function () { },
        //     hide: function () { },
        //     change: function() { },
        //     palette: [
